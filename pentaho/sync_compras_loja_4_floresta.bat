@echo off
TITLE SyncCompras - Loja 4 Floresta
SET currentdir=%~dp0
...
"%kitchen%" /file:"%currentdir%job_compras_loja_4_floresta.kjb" "/param:LOJA_ID=4" "/param:DATA_CORTE=2025-01-01" /level:Basic >> %logfile% 2>&1
