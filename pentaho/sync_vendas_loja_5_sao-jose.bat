@echo off
TITLE SyncVendas - Loja 5 Sao Jose
SET currentdir=%~dp0
...
"%kitchen%" /file:"%currentdir%job_vendas_loja_5_sao-jose.kjb" "/param:LOJA_ID=5" "/param:DATA_CORTE=2025-01-01" /level:Basic >> %logfile% 2>&1
